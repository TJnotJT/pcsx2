...
#define AA1_NEEDS_DEPTH (PS_AA1 == PS_AA1_TRIANGLE)
...
#define PS_FEEDBACK_LOOP_IS_NEEDED_DEPTH (PS_DEPTH_FEEDBACK && (AFAIL_NEEDS_DEPTH || AA1_NEEDS_DEPTH))
...
void main()
{
	...
	#if PS_ZCLAMP
	#if PS_FEEDBACK_LOOP_IS_NEEDED_DEPTH && (PS_AA1 == PS_AA1_TRIANGLE)
