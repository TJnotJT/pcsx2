...
#define ZWRITE (PS_ZCLAMP || PS_ZFLOOR || PS_FEEDBACK_LOOP_IS_NEEDED_DEPTH || (PS_ROV_DEPTH == PS_ROV_DEPTH_READ_WRITE))
...
#define PS_RETURN_DEPTH (ZWRITE && !PS_RETURN_DEPTH_ROV)
