...
static double s_last_copies_rov_depth = 0;
...
static u64 s_total_copies_rov_depth = 0;
...
void Host::BeginPresentFrame()
{
	...
	if (GSIsHardwareRenderer())
	{
		...
		update_stat(GSPerfMon::TextureCopiesROVDepth, s_total_copies_rov_depth, s_last_copies_rov_depth);
...
void GSRunner::DumpStats()
{
	...
	Console.WriteLn(fmt::format("@HWSTAT@ Copies (ROV Depth): {} (avg {})", s_total_copies_rov_depth, static_cast<u64>(std::ceil(s_total_copies_rov_depth / static_cast<double>(s_total_drawn_frames)))));
