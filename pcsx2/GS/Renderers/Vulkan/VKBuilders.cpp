	...
	bool feedback_loop, bool input_reference, bool subpass_self_dependency)
{
	...
	if (feedback_loop)
	{
		...
		if (input_reference)
		{
			...
			m_input_reference[m_num_subpass_inputs];
		...
		if (subpass_self_dependency)
		{
			...
			m_subpass_dependency[m_num_subpass_dependencies].srcStageMask = static_cast<VkPipelineStageFlags>(m_feedback_barriers.color.srcStageMask);
			m_subpass_dependency[m_num_subpass_dependencies].dstStageMask = static_cast<VkPipelineStageFlags>(m_feedback_barriers.color.dstStageMask);
			m_subpass_dependency[m_num_subpass_dependencies].srcAccessMask = static_cast<VkAccessFlags>(m_feedback_barriers.color.srcAccessMask);
			m_subpass_dependency[m_num_subpass_dependencies].dstAccessMask = static_cast<VkAccessFlags>(m_feedback_barriers.color.dstAccessMask);
	...
	bool feedback_loop, bool input_reference, bool subpass_self_dependency)
{
	...
	if (feedback_loop)
	{
		...
		if (subpass_self_dependency)
		{
			m_subpass_dependency[m_num_subpass_dependencies].srcSubpass = 0;
			m_subpass_dependency[m_num_subpass_dependencies].dstSubpass = 0;
			m_subpass_dependency[m_num_subpass_dependencies].srcStageMask = static_cast<VkPipelineStageFlags>(m_feedback_barriers.depth.srcStageMask);
			m_subpass_dependency[m_num_subpass_dependencies].dstStageMask = static_cast<VkPipelineStageFlags>(m_feedback_barriers.depth.dstStageMask);
			m_subpass_dependency[m_num_subpass_dependencies].srcAccessMask = static_cast<VkAccessFlags>(m_feedback_barriers.depth.srcAccessMask);
			m_subpass_dependency[m_num_subpass_dependencies].dstAccessMask = static_cast<VkAccessFlags>(m_feedback_barriers.depth.dstAccessMask);
			m_subpass_dependency[m_num_subpass_dependencies].dependencyFlags = m_feedback_barriers.dependency;
			m_num_subpass_dependencies++;
		}
	}
