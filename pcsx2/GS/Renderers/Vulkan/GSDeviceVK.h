...
public:
	enum FeedbackLoopFlag : u8
	{
		...
		FeedbackLoopFlag_ReadAndWriteDS = 4,
	};
	...
	struct alignas(8) PipelineSelector
	{
		...
		__fi bool IsDSFeedbackLoop() const { return ((feedback_loop_flags & FeedbackLoopFlag_ReadAndWriteDS) != 0); }
		__fi bool IsTestingAndSamplingDepth() const { return ((feedback_loop_flags & (FeedbackLoopFlag_ReadDS | FeedbackLoopFlag_ReadAndWriteDS)) != 0); }
	};
...
private:
	enum DIRTY_FLAG : u32
	{
		...
		DIRTY_FLAG_TFX_TEXTURE_DS = (DIRTY_FLAG_TFX_TEXTURE_0 << 4),
