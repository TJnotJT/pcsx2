...
namespace Vulkan
{
	...
	public:
		...
		void AddColorAttachment(VkFormat format, VkAttachmentLoadOp load_op, VkAttachmentStoreOp store_op, bool feedback_loop);
		void AddDepthStencilAttachment(VkFormat depth_format, VkAttachmentLoadOp depth_load_op, VkAttachmentStoreOp depth_store_op,
			VkAttachmentLoadOp stencil_load_op, VkAttachmentStoreOp stencil_store_op, bool depth_feedback_loop);
		
		void SetUseFeedbackLoopLayout(bool enable);
		void SetUseFrameBufferFetch(bool enable);

		void Clear();

		VkRenderPass Create(VkDevice device);
		
		static VkImageLayout GetColorLayout(bool feedback_loop, bool use_feedback_loop_layout);
		static VkImageLayout GetDepthLayout(bool feedback_loop, bool use_feedback_loop_layout);
		
		static VkPipelineStageFlags GetColorFeedbackLoopSrcStageMask();
		static VkPipelineStageFlags GetColorFeedbackLoopDstStageMask();
		static VkAccessFlags GetColorFeedbackLoopSrcAccessMask();
		static VkAccessFlags GetColorFeedbackLoopDstAccessMask(bool use_feedback_loop_layout);

		static VkPipelineStageFlags GetDepthFeedbackLoopSrcStageMask();
		static VkPipelineStageFlags GetDepthFeedbackLoopDstStageMask();
		static VkAccessFlags GetDepthFeedbackLoopSrcAccessMask();
		static VkAccessFlags GetDepthFeedbackLoopDstAccessMask(bool use_feedback_loop_layout);

		static VkDependencyFlags GetFeedbackLoopDependencyFlags(bool use_feedback_loop_layout);
	private:
