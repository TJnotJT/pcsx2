...
public:
	...
	VkFramebuffer GetLinkedFramebuffer(GSTextureVK* depth_texture, u32 feedback_loop_color, bool feedback_loop_depth);
...
private:
	...
	std::vector<std::tuple<GSTextureVK*, VkFramebuffer, u32, bool>> m_framebuffers;
};
