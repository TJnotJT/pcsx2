...
void GSDeviceVK::SubmitCommandBuffer(VKSwapChain* present_swap_chain)
{
	...
	if (present_swap_chain)
	{
		const VkPresentInfoKHR present_info = { .sType = VK_STRUCTURE_TYPE_PRESENT_INFO_KHR, .waitSemaphoreCount = 1,
			.pWaitSemaphores = present_swap_chain->GetRenderingFinishedSemaphorePtr(),
