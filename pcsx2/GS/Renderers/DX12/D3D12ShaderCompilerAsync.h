...
public:
	...
	static ComPtr<ID3D12PipelineState> GetOutput(const D3D12PipelineJob& job) { return job.GetPipeline(); }
	static ComPtr<ID3DBlob> GetOutput(const D3D12ShaderJob& job) { return job.GetBlob(); }
