...
public:
	...
	enum : u32
	{
		...
		TFX_ROOT_SIGNATURE_PARAM_PS_UAV_TEXTURES = 7,
...
public:
	...
	void SendHWDraw(const PipelineSelector& pipe, const GSHWDrawConfig& config, GSTexture12* draw_rt,
		...
		const bool feedback_depth, const bool one_barrier, const bool full_barrier);
...
private:
	enum DIRTY_FLAG : u32
	{
		...
		DIRTY_FLAG_TFX_UAV_TEXTURES = (1 << 6),
		DIRTY_FLAG_VS_CONSTANT_BUFFER_BINDING = (1 << 7),
		DIRTY_FLAG_PS_CONSTANT_BUFFER_BINDING = (1 << 8),
		DIRTY_FLAG_VS_VERTEX_BUFFER_BINDING = (1 << 9),
		DIRTY_FLAG_SAMPLERS_DESCRIPTOR_TABLE = (1 << 10),
		DIRTY_FLAG_TEXTURES_DESCRIPTOR_TABLE = (1 << 11),
		DIRTY_FLAG_TEXTURES_DESCRIPTOR_TABLE_2 = (1 << 12),
		DIRTY_FLAG_TEXTURES_DESCRIPTOR_TABLE_3 = (1 << 13),
		DIRTY_FLAG_TEXTURES_DESCRIPTOR_TABLE_4 = (1 << 14),

		DIRTY_FLAG_VERTEX_BUFFER = (1 << 15),
		DIRTY_FLAG_INDEX_BUFFER = (1 << 16),
		DIRTY_FLAG_PRIMITIVE_TOPOLOGY = (1 << 17),
		DIRTY_FLAG_VIEWPORT = (1 << 18),
		DIRTY_FLAG_SCISSOR = (1 << 19),
		DIRTY_FLAG_RENDER_TARGET = (1 << 20),
		DIRTY_FLAG_PIPELINE = (1 << 21),
		DIRTY_FLAG_BLEND_CONSTANTS = (1 << 22),
		DIRTY_FLAG_STENCIL_REF = (1 << 23),
		...
		DIRTY_BASE_STATE = DIRTY_FLAG_VS_CONSTANT_BUFFER_BINDING | DIRTY_FLAG_PS_CONSTANT_BUFFER_BINDING |
		                   ...
		                   DIRTY_FLAG_TEXTURES_DESCRIPTOR_TABLE_3 | DIRTY_FLAG_TEXTURES_DESCRIPTOR_TABLE_4 |
	...
	D3D12DescriptorHandle m_tfx_uav_textures_handle_gpu;
