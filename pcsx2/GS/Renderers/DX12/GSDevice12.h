...
private:
	...
	std::array<ComPtr<ID3D12PipelineState>, 3> m_colclip_setup_pipelines{}; // [depth]
	std::array<ComPtr<ID3D12PipelineState>, 3> m_colclip_finish_pipelines{}; // [depth]
	std::array<std::array<ComPtr<ID3D12PipelineState>, 4>, 3> m_date_image_setup_pipelines{}; // [depth][datm]
