...
private:
	...
	GSTexture* CreateSurface(
		GSTexture::Type type, int width, int height, int levels, GSTexture::Format format, GSTexture::ShaderAccess access) override;
...
public:
	...
	void PSSetShaderRWResource(GSTexture* rt, GSTexture* ds, bool write_rt, bool write_ds);
