...
public:
	...
	void OMSetRenderTargets(GSTexture* rt, GSTexture* ds, const GSVector4i& scissor, const GSVector2i& viewport_size = {});
	...
	void SendHWDraw(const PipelineSelector& pipe, const GSHWDrawConfig& config, GSTexture12* draw_rt, GSTexture12* draw_ds,
...
private:
	enum DIRTY_FLAG : u32
	{
		...
		DIRTY_FLAG_TFX_UAV_TEXTURES = (1 << 5),
		...
		DIRTY_BASE_STATE = DIRTY_FLAG_VS_CONSTANT_BUFFER_BINDING | DIRTY_FLAG_PS_CONSTANT_BUFFER_BINDING |
		                   ...
		                   DIRTY_FLAG_TEXTURES_DESCRIPTOR_TABLE_3 |
		...
		DIRTY_TFX_STATE =
			DIRTY_BASE_STATE | DIRTY_FLAG_TFX_TEXTURES | DIRTY_FLAG_TFX_SAMPLERS | DIRTY_FLAG_TFX_RT_TEXTURES | DIRTY_FLAG_TFX_UAV_TEXTURES,
