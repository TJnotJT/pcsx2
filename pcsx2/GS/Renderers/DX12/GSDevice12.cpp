...
bool GSDevice12::CreateNullTexture()
{
	...
	m_null_texture =
		GSTexture12::Create(null_type, GSTexture::Format::Color, 1, 1, 1, DXGI_FORMAT_R8G8B8A8_UNORM,
...
void GSDevice12::PSSetShaderResourceRW(GSTexture* rt, GSTexture* ds, bool write_rt, bool write_ds)
{
	GSTexture12* d12Rt = static_cast<GSTexture12*>(rt);
	GSTexture12* d12Ds = static_cast<GSTexture12*>(ds);
