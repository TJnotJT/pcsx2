...
bool GSDevice12::CreateSwapChainRTV()
{
	...
	for (u32 i = 0; i < swap_chain_desc.BufferCount; i++)
	{
		...
		std::unique_ptr<GSTexture12> tex = GSTexture12::Adopt(std::move(backbuffer), GSTexture::RenderTarget, GSTexture::Format::Color,
...
{
	const GSTexture::Usage null_access = m_features.rov ? GSTexture::ShaderWriteTarget : GSTexture::RenderTarget;
