...
protected:
	...
	virtual GSTexture* CreateSurface(GSTexture::Type type, int width, int height, int levels, GSTexture::Format format,
		GSTexture::ShaderAccess access = GSTexture::ShaderAccess::ReadOnly) = 0;
	GSTexture* FetchSurface(GSTexture::Type type, int width, int height, int levels, GSTexture::Format format, bool clear, bool prefer_unused_texture,
		GSTexture::ShaderAccess access = GSTexture::ShaderAccess::ReadOnly);
