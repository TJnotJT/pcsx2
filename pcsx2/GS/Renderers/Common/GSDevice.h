...
public:
	...
	GSTexture* FetchSurface(GSTexture::Usage usage, GSVector2i size, int levels, GSTexture::Format format, bool clear,
		bool prefer_unused_texture);
	GSTexture* FetchSurface(GSTexture::Usage usage, int width, int height, int levels, GSTexture::Format format, bool clear,
		bool prefer_unused_texture);
	...
	GSTexture* CreateFeedbackDepth(int w, int h, bool clear = true, bool prefer_reuse = true);
	GSTexture* CreateFeedbackDepth(const GSVector2i& size, bool clear = true, bool prefer_reuse = true);
	...
	GSTexture* CreateShaderWriteTexture(int w, int h, GSTexture::Format format, bool clear = true, bool prefer_reuse = true);
	GSTexture* CreateShaderWriteTexture(const GSVector2i& size, GSTexture::Format format, bool clear = true, bool prefer_reuse = true);
