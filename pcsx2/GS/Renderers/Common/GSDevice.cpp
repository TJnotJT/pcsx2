...
static const char* GetPSROVColorName(GSHWDrawConfig::PS_ROV_COLOR rov_color)
{
	switch (rov_color)
	{
		case GSHWDrawConfig::PS_ROV_COLOR::NONE: return "NONE";
		case GSHWDrawConfig::PS_ROV_COLOR::ENABLED: return "ENABLED";
		case GSHWDrawConfig::PS_ROV_COLOR::ONESHOT_ENABLED: return "ONESHOT_ENABLED";
	}
	return "Unknown";
}
...
static const char* GetPSROVDepthName(GSHWDrawConfig::PS_ROV_DEPTH rov_depth)
{
	switch (rov_depth)
	{
		...
		case GSHWDrawConfig::PS_ROV_DEPTH::ONESHOT_READ_ONLY: return "ONESHOT_READ_ONLY";
		case GSHWDrawConfig::PS_ROV_DEPTH::ONESHOT_READ_WRITE: return "ONESHOT_READ_WRITE";
	}
	return "Unknown";
}
...
static void DumpPSSelector(DrawConfigWriter& out, const GSHWDrawConfig::PSSelector& ps)
{
	...
	out.WriteLn("rov_color: {} ({})", GetPSROVColorName(ps.rov_color), static_cast<u32>(ps.rov_color));
