...
private:
	...
	{
		std::string vs;
		std::unordered_map<ShaderConvertKey, GLProgram, ShaderConvertKeyHash> ps; // program object
...
protected:
	...
	virtual ShaderConvertKey ProcessShaderConvertKey(ShaderConvertKey shader) const
	{
...
public:
	...
	void DrawMultiStretchRects(const MultiStretchRect* rects, u32 num_rects, GSTexture* dTex, ShaderConvertKey shader) override;
