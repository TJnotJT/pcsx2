...
private:
	...
	wil::com_ptr_nothrow<ID3D11Buffer> m_accurate_lines_b;
	wil::com_ptr_nothrow<ID3D11ShaderResourceView> m_accurate_lines_b_srv;
...
public:
	...
	bool SetupAccurateLines(GSHWDrawConfig& config);
