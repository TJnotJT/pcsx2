...
protected:
	...
	TextureMinMaxResult GetTextureMinMax(GIFRegTEX0 TEX0, GIFRegCLAMP CLAMP, bool linear, bool expand_region_mode);
	void GetTextureMinMaxAxisAlignedHelper(GIFRegTEX0 TEX0, u32 fst, bool linear, const GSVertex* vertex, u16 index0, u16 index1, GSVector4* minmax);
	bool GetTextureMinMaxAxisAligned(GIFRegTEX0 TEX0, GIFRegCLAMP CLAMP, bool linear, GSState::TextureMinMaxResult* result);
