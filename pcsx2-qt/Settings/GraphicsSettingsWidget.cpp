	...
	: SettingsWidget(settings_dialog, parent)
{
	...
	SettingWidgetBinder::BindWidgetToIntSetting(
		sif, m_hw.rovPreset, "EmuCore/GS", "HWROVPreset", static_cast<int>(GSROVPreset::Disabled));
	...
	// Rendering tab
	{
		...
		dialog()->registerWidgetHelp(m_hw.rovPreset, tr("ROV Preset"), tr("Disabled"),
			tr("Control the heuristic to dynamically choose ROVs for draws.<br> "
			   "Determines how often and for how long ROVs are used in a sequence of draws. Requirements may vary in different games."));
